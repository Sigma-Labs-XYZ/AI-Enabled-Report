...
/**
 * Initialize Lines of Code Comparison Chart
 */
async function initLinesOfCodeChart() {
  try {
    const data = await fetchJSON("./data/lines-of-code-comparison.json");
    const ctx = document.getElementById("linesOfCodeChart");
    ...
    const chart = new Chart(ctx, {
      ...
      options: {
        ...
        plugins: {
          ...
          title: {
            display: true,
            text: "Lines of Code: AI vs Traditional Teams",
            color: "#e88856",
            font: {
              size: 18,
              weight: "bold",
          ...
          tooltip: {
            ...
            callbacks: {
              label: function (context) {
                ...
                }: ${context.parsed.y.toLocaleString()} lines`;
              },
            },
          },
        },
    ...
    appState.setChart("linesOfCodeChart", chart);
  } catch (error) {
    console.error("Error initializing lines of code chart:", error);
  }
}

/**
 * Initialize Function Complexity Comparison Chart
 */
async function initComplexityChart() {
  try {
    const data = await fetchJSON("./data/function-complexity-comparison.json");
    ...
    const chart = new Chart(ctx, {
      ...
      options: {
        ...
        plugins: {
          ...
          title: {
            display: true,
            text: "Average Function Complexity (lower is better)",
            color: "#e88856",
            font: {
              size: 18,
              weight: "bold",
    ...
    appState.setChart("complexityChart", chart);
  } catch (error) {
    console.error("Error initializing complexity chart:", error);
  }
}
